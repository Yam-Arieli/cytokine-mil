"""Stage 6 of the Oesinghaus 90-cytokine PURE run — signature-space coupling, all 4005 pairs.
...
def main() -> int:
    ...
    n = len(coupling)
    C.log(f"\n[gates] over the neutral {n}-pair family:")
    ...
    C.write_json(out / "coupling_meta.json", {
        **prov,
        "n_pairs": n,
        "donor_level": True,
        "degree_correct": True,
